...
class TestSessionMethods:
    ...
    def TestAllMethods(logsi:SISession) -> None:
        ...
        try:
            ...
            logsi.EnterMethod(SILevel.Fatal, "EnterMethod Fatal Example (with color)", SIColors.Gold)
            ...
            logsi.LeaveMethod(SILevel.Fatal, "LeaveMethod Fatal Example (with color)", SIColors.Gold)
            ...
            # LogThread Examples.
            logsi.LogColored(SILevel.Fatal, SIColors.LightSkyBlue, "Py LogThread Examples (using threading.current_thread()).")
            logsi.LogThread(None, "LogThread NoLevel Example", threading.current_thread())
            logsi.LogThread(SILevel.Debug, "LogThread Debug Example", threading.current_thread())
            logsi.LogThread(SILevel.Verbose, "LogThread Verbose Example", threading.current_thread())
            logsi.LogThread(SILevel.Message, "LogThread Message Example", threading.current_thread())
            logsi.LogThread(SILevel.Warning, "LogThread Warning Example", threading.current_thread())
            logsi.LogThread(SILevel.Error, "LogThread Error Example", threading.current_thread())
            logsi.LogThread(SILevel.Fatal, "LogThread Fatal Example", threading.current_thread())
            logsi.LogThread(SILevel.Fatal, "LogThread Fatal Example (null object)", None)

            logsi.LogThread(thread=threading.current_thread())
            logsi.LogThread(SILevel.Debug, thread=threading.current_thread())
            logsi.LogThread(SILevel.Verbose, thread=threading.current_thread())
            logsi.LogThread(SILevel.Message, thread=threading.current_thread())
            logsi.LogThread(SILevel.Warning, thread=threading.current_thread())
            logsi.LogThread(SILevel.Error, thread=threading.current_thread())
            logsi.LogThread(SILevel.Fatal, thread=threading.current_thread())
            ...
            # LogXmlFile Examples.
            testdataPath = testdataPfx + "TestSourceXML.xml"
            logsi.LogColored(SILevel.Fatal, SIColors.LightSkyBlue, "Py LogXmlFile Examples.")
            logsi.LogXmlFile(None, "LogXmlFile NoLevel Example", testdataPath)
            logsi.LogXmlFile(SILevel.Debug, "LogXmlFile Debug Example", testdataPath)
            logsi.LogXmlFile(SILevel.Verbose, "LogXmlFile Verbose Example", testdataPath)
            logsi.LogXmlFile(SILevel.Message, "LogXmlFile Message Example", testdataPath)
            logsi.LogXmlFile(SILevel.Warning, "LogXmlFile Warning Example", testdataPath)
            logsi.LogXmlFile(SILevel.Error, "LogXmlFile Error Example", testdataPath)
            logsi.LogXmlFile(SILevel.Fatal, "LogXmlFile Fatal Example", testdataPath)
